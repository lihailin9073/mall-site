...
public class Swagger2Config {
    ...
    Docket docket1() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.wzliulan.mall.auth.controller"))
    ...
    Docket docket2() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("goods-商品管理")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.wzliulan.mall.admin.controller.goods"))
                .paths(PathSelectors.any())
                .build()
                .globalOperationParameters(params)
    ...
    Docket docket3() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("order-订单管理")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.wzliulan.mall.admin.controller.order"))
                .paths(PathSelectors.any())
                .build()
                .globalOperationParameters(params)
